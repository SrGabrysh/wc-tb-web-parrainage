...
jQuery(document).ready(function($) {
    ...
    function showHelpModal(title, content) {
        ...
        var modalHtml = '<div id="' + modalId + '" class="tb-client-help-modal">' +
                       '<div class="tb-client-help-content">' + content + '</div>' +
                       '</div>';
        ...
        $modal.dialog({
            ...
            draggable: false,
            resizable: false,
            closeText: tbClientHelp.strings.close || 'Fermer',
            position: {
                my: 'center',
                at: 'center',
                of: window
            ...
            open: function() {
                ...
                // Analytics : track ouverture modal
                if (typeof gtag !== 'undefined') {
                    gtag('event', 'help_modal_open', {
            ...
            close: function() {
                ...
                // Supprimer l'overlay personnalisé
                $('.ui-widget-overlay').removeClass('tb-client-overlay');
            ...
            buttons: [
                {
                    text: tbClientHelp.strings.close || 'Fermer',
                    class: 'button button-primary tb-close-modal',
                    click: function() {
                        $(this).dialog('close');
                    }
                }
    ...
    function showErrorModal() {
        var errorContent = '<div class="help-definition" style="border-color: #f44336;">' +
    ...
    function enhanceIconInteractions() {
        $(document).on('mouseenter', '.tb-client-help-icon', function() {
